...
void loop() 
{
  ...
  if(i == 0){
                  while (wifiCheck.available() > 0) {
                      char WIFI_Status = wifiCheck.read();  
        ...
        SampleCounter++; 
    switch(i){
      case 0: Serial.print("Measurement: ");Serial.print(i);
      break;
      case 11:Serial.print('.');Serial.print(i);Serial.print("//");
                Serial.print(SampleCounter);Serial.println();
 ...
 // end averaging
  ...
  if (i==12) //occurs once per appx. 30 sec
  {
   ...
   // Serial.println(StrToSend);
    Serial.print(StrToSend);Serial.print("   ");
