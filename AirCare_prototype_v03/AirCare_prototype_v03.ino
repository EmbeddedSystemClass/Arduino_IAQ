...
void setup()
{
  ...
  Serial.println("start..");  // print out 'setup..' on start
}

void loop() 
{
 //  Serial.println("1.");  // print out 'setup..' on start 
  StrToSend="";
  TimeStart=0;
  TimeEnd=0;
  TimeToDelay=0;
 ...
 //   Serial.println("2.");  // print out 'setup..' on start
  co_sensor.listen();  // since there are 2 sw serial ports 
//  Serial.println("3.");  // print out 'setup..' on start
  delay(100);
  while (!co_sensor.isListening())
  {
    delay(1);
  }
  //Serial.println("4.");  // print out 'setup..' on start
